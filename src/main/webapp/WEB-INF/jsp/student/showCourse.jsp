				...
				<div class="panel panel-default">
				    <div class="panel-heading">
						<div class="row">
							...
							<form class="bs-example bs-example-form col-md-5" role="form" style="margin: 20px 0 10px 0;" action="/student/findCourse" id="form1" method="post">
						...
						<%--<c:if test="${pagingVO != null}">--%>
							<nav style="text-align: center">
								<ul class="pagination">
									...
									<li>	<h5>当前<font color="red"> ${coursePageInfo.pageNum }</font>页,总<font color="red"> ${coursePageInfo.pages }</font>
										页,总<font color="red"> ${coursePageInfo.total}</font>条记录</h5></li>

                            <li class="active"><a href="showCourse?pageNo=${coursePageInfo.firstPage}">第一页</a></li>

				<c:if test="${coursePageInfo.hasPreviousPage }">
                    <li><a href="showCourse?pageNo=${coursePageInfo.pageNum-1}">上一页</a></li>
				</c:if>

				<c:if test="${coursePageInfo.hasNextPage }">
                    <li><a href="showCourse?pageNo=${coursePageInfo.pageNum+1}">下一页</a></li>
				</c:if>

                            <li><a href="showCourse?pageNo=${coursePageInfo.lastPage}">最后页</a></li>
